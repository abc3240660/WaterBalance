            ...
            if (1 == start) {
                ...
                if (f_ev1527_ok) {
                    ...
                    if (t16_10ms_rmt) {// period = 10ms
						...
						if (f_Key_Trig8) {
							if (tt_rm_rels_cnt >= 2){// 100ms
								f_Key_Trig8 = 0;
								if (!f_Key_Trig6 && !f_Key_Trig5) {
									p_OutA_MTA = 0;
									p_OutA_MTB = 0;
									f_Key_Trig7 = 0;
									f_Key_Trig8 = 0;
								} else {
									// if (tt_rm_rels_cnt >= 20){
										f_Key_Trig5 = 0;
										f_Key_Trig6 = 0;

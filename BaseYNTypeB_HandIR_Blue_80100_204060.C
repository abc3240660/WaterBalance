...
BIT     p_InA_H     :   PA.5;// PB.6 -> PA.5
BIT     p_InA_VJ    :   PA.4;// PB.5 -> PA.4
...
void FPPA0 (void)
{
    ...
    // IN Pull-UP
    PAPH        =        _FIELD(p_InA_H, p_InA_M, p_InA_V, p_InA_RF);
    PBPH        =        _FIELD(p_InB_RF_IR);
    ...
    BYTE    Key_Flag;
    Key_Flag            =    _FIELD(p_InA_H, p_InA_VJ, p_InA_M, p_InA_V);
...
//    fppen    =    0xFF;
	...
	//XXX 0-DC(100%) 1-80% 2-60% 3-40% 4-20%
	//YYY 0-80% 1-DC(100%) 2-20% 3-40% 4-60%
	BYTE	duty_mode = 0;
                        ...
                        if (!f_M_disable) {// period = 200ms
                            ...
                            if (od_rm_rels_cnt > 25) {// 250ms = 4~5 whole ev1527 period
								...
								if (0 == duty_mode) {// 80%
									val1 = 80;
									val2 = 0;
								} else if (1 == duty_mode) {// 100%
									val1 = 0;
									val2 = 1;
								} else if (2 == duty_mode) {// 20%
									val1 = 20;
									val2 = 0;
								} else if (3 == duty_mode) {// 40%
									val1 = 40;
									val2 = 0;
								} else if (4 == duty_mode) {// 60%
									val1 = 60;
									val2 = 0;
								} else {// 100%
									val1 = 0;

...
void    FPPA0 (void)
{
    ...
    // IN Pull-UP
    PBPH        =        _FIELD(p_InB_OD, p_InB_V, p_InB_RF);
    ...
    BYTE    Key_Flag;
    Key_Flag            =    _FIELD(p_InB_OD, p_InA_VJ, p_InB_V, p_InA_QV2, p_InA_QV3);

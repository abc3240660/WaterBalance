...
BIT     p_InB_H     :   PB.5;// PB.2 -> PB.5
BIT     p_InB_OD    :   PB.7;// PB.1 -> PB.6
BIT     p_InB_V     :   PB.6;// PA.7 -> PB.7
BIT     p_InA_RF    :   PA.0;// PA.6 -> PA.0

BIT     p_OutA_2K   :   PA.3;// PB.6 -> PA.3
BIT     p_OutA_V1   :   PA.7;// PA.0 -> PA.7
BIT     p_OutB_V2   :   PB.0;// OK
BIT     p_OutA_H1   :   PA.4;// PB.0 -> PA.6
BIT     p_OutA_V3   :   PA.6;// PA.3 -> PB0.3

...
BIT        p_InA_VJ    :    PA.5;// OK
BIT        p_InB_V     :    PB.2;// OK
BIT        p_InB_H     :    PB.1;// OK

BIT        p_InA_QV2   :    PA.6;// PA.3 -> PA.6
BIT        p_InA_QV3   :    PA.4;
BIT        p_InA_RF_IR :    PA.0;// PB.6 -> PA.0
BIT        p_InB_RF_43 :    PB.0;// PA.0 -> PB.0

BIT        p_OutA_2K   :    PA.3;// PB.5 -> PA.3
BIT        p_OutB_H1   :    PA.7;// PB.7 -> PA.7
BIT        p_OutA_V1   :    PB.7;// PA.7 -> PB.7
BIT        p_OutB_V2   :    PB.6;// PA.6 -> PB.6
BIT        p_OutB_IR   :    PB.5;
...
void    FPPA0 (void)
{
    ...
    // IN Pull-UP
	PAPH        =        _FIELD(p_InA_QV2, p_InA_QV3);
    PBPH        =        _FIELD(p_InA_RF_IR, p_InB_RF_43, p_InB_V, p_InB_H);
    ...
    BYTE    Key_Flag;
    Key_Flag            =    _FIELD(p_InA_VJ, p_InB_V, p_InB_H, p_InA_QV2, p_InA_QV3);
...
//    fppen    =    0xFF;
	...
	// DB = 8 + 0*0.5 + 0.5 = 8.5
	pwmg0dtl = 0b0000_0000;
	pwmg0dth = 0b0000_0010;
